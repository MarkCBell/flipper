...
class MappingClassApp:
	def __init__(self, host_app, name, mapping_class):
		...
		self.parent.columnconfigure(0, pad=3)
		self.parent.columnconfigure(1, pad=3)
		self.parent.columnconfigure(2, pad=3)
		self.parent.rowconfigure(0, pad=3)
		self.parent.rowconfigure(1, pad=3)
		self.parent.rowconfigure(2, pad=3)
