...
\title{A users guide to flipper (0.7.6)}
\author{Mark Bell}
...
\item Some of the Sage functions used by flipper were added in Sage 6.5. If you are running an earlier version of Sage this can result in errors such as \texttt{TypeError: coefficients() takes no keyword arguments}. Consider upgrading your version of Sage before using flipper.
\end{itemize}
