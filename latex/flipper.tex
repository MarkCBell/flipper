...
\item Isometry - An isometry of the underlying triangulation can be created by using the action \exc{Create > Mapping class > Isometry}. The available isometries are listed according to how they map edges.
